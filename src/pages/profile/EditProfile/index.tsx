 ...
 const updateUserInCache = (updatedUser: User) => {
  ...
  const handleRiotDetailsSubmit = async (values: any) => {
    try {
      ...
      console.log(t("Riot Details Saved:"), response.data);
      toast.success(t("Riot Details updated successfully!"));
      window.location.reload();
    } catch (error) {
      ...
      //  console.error("Error saving Riot Details:", error);
       // console.error("Error response:", error.response);  // Verifique toda a resposta aqui
        ...
        toast.error(t("Unknown error occurred."));
      }
    }
  };
      ...
      <Backgroundgradient>
        ...
        <Components.Banner className={`banner ${active ? 'active' : ''}`}>
          ...
          <Components.UserBanner>
            ...
            <Components.avatarEditProfileSpan>{t("EditProfile")}</Components.avatarEditProfileSpan>
            <Components.avatar>
            ...
            <Components.UserOptionsEditBanner>
              <Components.optionDiv>
                <Components.optionLi onClick={() => setSelectedOption('General')}>{t("General")}</Components.optionLi>
                <Components.optionLi onClick={() => setSelectedOption('Riot Detail')}>{t("Riot Detail")}</Components.optionLi>
              </Components.optionDiv>
            </Components.UserOptionsEditBanner>
          </Components.UserBanner>
  ...
  >
    {({ handleChange, values, handleSubmit, isSubmitting, setFieldValue }) => (
      <Components.formEditProfile autoComplete="off" onSubmit={handleSubmit}>
        <Components.formEditLabel htmlFor="nickname">{t("Profile Name")}</Components.formEditLabel>
        ...
        <Components.formEditLabel htmlFor="pixKey">{t("Pix Key")}</Components.formEditLabel>
        <Components.formEditInput
          type="text"
          id="pixKey"
          name="pixKey"
        ...
        <Components.formEditLabel htmlFor="password">{t("Password")}</Components.formEditLabel>
        <Components.formEditInput
          type="password"
          id="password"
          name="password"
        ...
        <Components.formEditLabel htmlFor="confirmNewPassword">{t("Confirm New Password")}</Components.formEditLabel>
        <Components.formEditInput
          type="password"
        ...
        <Components.buttonSave type="submit" disabled={isSubmitting}>{t("Save")}</Components.buttonSave>
...
{selectedOption === 'Riot Detail' && (
  ...
  >
    {({ handleChange, values, handleSubmit, isSubmitting }) => (
      <Components.formEditProfile autoComplete="off" onSubmit={handleSubmit}>
        <Components.formEditLabel htmlFor="gameName">{t("Game Name")}</Components.formEditLabel>
        <Components.formEditInput
          type="text"
          id="gameName"
          name="gameName"
        ...
        <Components.formEditLabel htmlFor="tagLine">{t("Tag")}</Components.formEditLabel>
        <Components.formEditInput
          type="text"
          id="tagLine"
          name="tagLine"
        ...
        type="submit" hidden={active}>{t("Save Riot Detail")}</Components.buttonSave>
        ...
        <Components.buttonSave
          ...
          onClick={async () => {
            try {
              ...
              toast.success(t("Riot account disconnected successfully!"));
              setAccountDetails({ gameName: '', tagLine: '' });  // Limpa os dados da conta
            } catch (error) {
              toast.error(t("Error disconnecting from Riot account."));
            }
          }}
        >
          {t("Disconnect Riot Account")}
        </Components.buttonSave>
      </Components.formEditProfile>
    )}
  </Formik>
