                ...
                <>
                  ...
                  <DataCard>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                      <BookOnlineIcon/>
                      <span><strong>{t('Chips')} : </strong> {data.qntChipsPerPlayer || 'Não disponível'}</span>
                    </div>
                  </DataCard>
                  ...
                  <DataCard>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                      <MoreHorizIcon />
                      <span><strong> {t('Status : Ongoing')} </strong> </span>
                    </div>
                  </DataCard>
                  ...
                  <DataCard>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                      <EmojiEventsIcon/>
                      <span><strong>{t('Winner')};</strong> {data.winner || ''}</span>
                    </div>
                  </DataCard>
  
                  <DataCard>
                    <div>
                      <strong>{t("Tournament Progress")} </strong>
                  ...
                  <DataCard>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                      <SportsMmaIcon />
                      <span><strong>{t("Round:")}</strong> {round !== null ? `Rodada ${round}` : 'Não disponível'}</span>
                    </div>
                  </DataCard>
